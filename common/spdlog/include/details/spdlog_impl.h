...
inline std::shared_ptr<spdlog::logger> spdlog::rotating_logger_mt(const std::string& logger_name, const std::string& filename, size_t max_file_size, size_t max_files, bool force_flush, std::string suffix)
{
    return create<spdlog::sinks::rotating_file_sink_mt>(logger_name, filename, suffix, max_file_size, max_files, force_flush);
}

inline std::shared_ptr<spdlog::logger> spdlog::rotating_logger_st(const std::string& logger_name, const std::string& filename, size_t max_file_size, size_t max_files, bool force_flush, std::string suffix)
{
    return create<spdlog::sinks::rotating_file_sink_st>(logger_name, filename, suffix, max_file_size, max_files, force_flush);
}
